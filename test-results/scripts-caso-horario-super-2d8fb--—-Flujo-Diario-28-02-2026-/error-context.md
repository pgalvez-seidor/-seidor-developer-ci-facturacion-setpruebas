          ...
          - generic [ref=f1e1]:
            ...
            - generic [ref=f1e5]:
                ...
                - contentinfo [ref=f1e1770]:
                  - toolbar "Footer actions" [ref=f1e1771]:
                    - button "Eliminar Supervisor" [ref=f1e1773] [cursor=pointer]:
                      - generic [ref=f1e1775]: 
                    - button "Agregar Supervisor" [active] [ref=f1e1776] [cursor=pointer]:
                      - generic [ref=f1e1778]: 
              ...
              - generic [ref=f1e1783]:
                ...
                - generic [ref=f1e1785]:
                  - banner [ref=f1e1786]:
                    - heading "Agregar Asignación" [level=2] [ref=f1e1789]
                  - generic [ref=f1e1790]:
                    - form "Datos Asignación" [ref=f1e1791]:
                      - heading "Datos Asignación" [level=2] [ref=f1e1792]:
                        - generic [ref=f1e1793]: Datos Asignación
                      - region [ref=f1e1798]:
                        - generic [ref=f1e1800]:
                          - form [ref=f1e1802]:
                            - heading [level=5] [ref=f1e1803]
                            - generic [ref=f1e1805]:
                              - generic [ref=f1e1808]:
                                - generic [ref=f1e1809]: Sede
                                - generic [ref=f1e1810]: ":"
                              - generic [ref=f1e1812] [cursor=pointer]:
                                - combobox "Sede" [ref=f1e1813]: SAN ISIDRO
                                - textbox [ref=f1e1814]: "246"
                                - generic [ref=f1e1815]: SAN ISIDRO
                                - text: 
                              - generic [ref=f1e1818]:
                                - generic [ref=f1e1819]: Supervisor
                                - generic [ref=f1e1820]: :*
                              - textbox "Supervisor" [disabled] [ref=f1e1824]:
                                - /placeholder: Ingrese Supervisor
                          - form [ref=f1e1826]:
                            - heading [level=5] [ref=f1e1827]
                            - generic [ref=f1e1829]:
                              - generic [ref=f1e1832]:
                                - generic [ref=f1e1833]: Área
                                - generic [ref=f1e1834]: :*
                              - generic [ref=f1e1836] [cursor=pointer]:
                                - combobox "Área" [ref=f1e1837]: Seleccione Área
                                - textbox [ref=f1e1838]
                                - generic [ref=f1e1839]: Seleccione Área
                                - generic [ref=f1e1840]: 
                              - generic [ref=f1e1843]:
                                - generic [ref=f1e1844]: Período
                                - generic [ref=f1e1845]: :*
                              - generic [ref=f1e1848]:
                                - textbox "Período":
                    ...
                    - generic [ref=f1e1854]:
                      - toolbar "Horario" [ref=f1e1857]:
                        - heading "Horario" [level=2] [ref=f1e1859]
                        - button "Eliminar Selección" [ref=f1e1861] [cursor=pointer]:
                          - generic [ref=f1e1863]: 
                        - button "Agregar Detalle" [ref=f1e1864] [cursor=pointer]:
                          - generic [ref=f1e1866]: 
                      - grid [ref=f1e1868]:
                        - generic [ref=f1e1870]:
                          - checkbox [ref=f1e1871] [cursor=pointer]
                          - row "Semana Fecha Inicio Fecha Fin" [ref=f1e1874]:
                            - columnheader "Semana" [ref=f1e1875]:
                              - generic [ref=f1e1880]: Semana
                            - columnheader "Fecha Inicio" [ref=f1e1881]:
                              - generic [ref=f1e1886]: Fecha Inicio
                            - columnheader "Fecha Fin" [ref=f1e1887]:
                              - generic [ref=f1e1892]: Fecha Fin
                            - columnheader [ref=f1e1893]
                            - columnheader [ref=f1e1896]
                        - generic [ref=f1e1899]:
                          - table [ref=f1e1902]:
                            - rowgroup [ref=f1e1903]:
                              - row [ref=f1e1904]:
                                - gridcell [ref=f1e1905]
                                - gridcell [ref=f1e1906]: 
                                - gridcell [ref=f1e1907]: 
                                - gridcell [ref=f1e1908]: 
                                - gridcell [ref=f1e1909]: 
                                - gridcell [ref=f1e1910] [cursor=pointer]
                          - row [ref=f1e1912]
                          - gridcell "No data" [ref=f1e1913]:
                            - generic [ref=f1e1914]: No data
                  - contentinfo [ref=f1e1915]:
                    - button "Save" [ref=f1e1918] [cursor=pointer]:
                      - generic [ref=f1e1920]: 
    - contentinfo
```